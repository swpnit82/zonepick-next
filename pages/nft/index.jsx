                                                ...
                                                return (
                                                    val.metadata && (
                                                        <Col key={idx} md={3} className="mb-3">
                                                            <Card>
                                                                <Card.Body>
                                                                <a href={`https://testnets.opensea.io/assets/rinkeby/${val?.token_address}/${val?.token_id}`} target="_blank">
                                                                    <img
                                            ...
                                            totalNFts.map((val, idx) => {
                                                return (
                                                    <Col key={idx} md={3} className="mb-3">
                                                        <Card>
                                                            <Card.Body>
                                                            <a href={`https://solscan.io/token/${val?.mint}?cluster=devnet`} target="_blank">
                                                                <img
                                                                    className="ic-card-img-top mb-2"
